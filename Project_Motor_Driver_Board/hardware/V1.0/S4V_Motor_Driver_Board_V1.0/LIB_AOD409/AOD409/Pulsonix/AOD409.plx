...
(library Library_1
	...
	(patternDef "AOD409" (originalName "AOD409")
		...
		(layerContents (layerNumRef 28)
			(line (pt -3.302 3.048) (pt 3.302 3.048) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.302 3.048) (pt 3.302 -3.048) (width 0.025))
		)
	...
	(compDef "AOD409" (originalName "AOD409") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "http://www.aosmd.com/res/data_sheets/AOD409.pdf")
		(attr "<Component Height>" "2.4")
		(attr "<STEP Filename>" "AOD409.stp")
		(attr "<STEP Offsets>" "X=0;Y=1.84;Z=0")
